...
const obtenerPorCedula = async (cedula) => {
    const data = await fetch(`http://localhost:8082/API/v1.0/Matricula/estudiantes/cedula/${cedula}`).then(r => r.json());
    console.log(data);
    return data;
}
...
const actualizar = async (cedula, estudianteBody) => {
    const data = axios.put(`http://localhost:8082/API/v1.0/Matricula/estudiantes/cedula/${cedula}`, estudianteBody).then(r => r.data);
    console.log(data);
    return data;
}
...
const actualizarParcial = async (cedula, estudianteBody) => {
    const data = axios.patch(`http://localhost:8082/API/v1.0/Matricula/estudiantes/cedula/${cedula}`, estudianteBody).then(r => r.data);
    console.log(data);
    return data;
}
